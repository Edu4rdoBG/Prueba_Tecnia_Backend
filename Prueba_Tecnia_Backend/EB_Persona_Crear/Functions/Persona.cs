...
using EB_Persona_Crear.Functions.Data;
using EB_Persona_Crear.Models;

namespace EB_Persona_Crear.Functions
{
    public class Persona
    {
        private ResponsePersona response = null;
        private string mensaje = "";
        public ResponsePersona Insert(RequestPersona input)
        {
            ...
            if (!DataProvider.Execute_sp_insert_eb_persona(input, out mensaje, out persona))
            {
